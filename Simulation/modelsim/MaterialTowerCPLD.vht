...
-- ***************************************************************************
-- Generated on "04/13/2018 09:35:02"
...
COMPONENT MaterialTowerCPLD
	...
	CAN1_TXD : BUFFER STD_LOGIC;
	CAN2_RXD : IN STD_LOGIC;
	CAN2_TXD : BUFFER STD_LOGIC;
	CC_CAN1_RXD : BUFFER STD_LOGIC;
	CC_CAN1_TXD : IN STD_LOGIC;
	CC_CAN2_RXD : BUFFER STD_LOGIC;
	...
	ENC_1_DIR : BUFFER STD_LOGIC;
	ENC_1_INX : BUFFER STD_LOGIC;
	ENC_1_N : IN STD_LOGIC;
	ENC_1_PS : BUFFER STD_LOGIC;
	ENC_2_A : IN STD_LOGIC;
	ENC_2_B : IN STD_LOGIC;
	ENC_2_DIR : BUFFER STD_LOGIC;
	ENC_2_INX : BUFFER STD_LOGIC;
	ENC_2_N : IN STD_LOGIC;
	ENC_2_PS : BUFFER STD_LOGIC;
	ENC_ERR : BUFFER STD_LOGIC;
	FAN_PULSE : IN STD_LOGIC;
	FAN_PWM : BUFFER STD_LOGIC;
	FPGA_OK : BUFFER STD_LOGIC;
	...
	IO_Output : BUFFER STD_LOGIC_VECTOR(16 DOWNTO 0);
	...
	nWAIT : IN STD_LOGIC;
	nWR : IN STD_LOGIC;
	PIZZA_CALIBRATION : BUFFER STD_LOGIC;
	PWM_LED : IN STD_LOGIC;
	RST : BUFFER STD_LOGIC;
	SDCLKO : IN STD_LOGIC;
	Seg_LED : BUFFER STD_LOGIC_VECTOR(7 DOWNTO 0)
	);
END COMPONENT;
BEGIN
